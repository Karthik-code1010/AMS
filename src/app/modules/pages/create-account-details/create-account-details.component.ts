...
export class CreateAccountDetailsComponent implements OnInit {
  ...
  @ViewChild('acForm') acForm!: NgForm;
  @ViewChild('amForm') amForm!: NgForm;
  @ViewChild('amcForm') amcForm!: NgForm;
  ...
  accountSaveOnly(){
    this.form0.markAsTouched();
    (this.pForm as any).submitted = true;
    this.form1.markAsTouched();
    (this.uForm as any).submitted = true;

    this.form2.markAsTouched();
    (this.acForm as any).submitted = true;
    this.form3.markAsTouched();
    (this.amForm as any).submitted = true;
    this.form4.markAsTouched();
    (this.amcForm as any).submitted = true;

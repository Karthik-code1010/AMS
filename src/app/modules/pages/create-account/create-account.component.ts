      ...
      fieldGroup: [
        {
          ...
          validation: {
            messages: {
              pattern: (error, field: FormlyFieldConfig) => `This Field is required`,
            },
          },
        },
        {
      ...
      //   });
        ...
        "refAccountID":{
         ...
         "legalName":{
          ...
          "organizationLogo":{
              "type": "Property",
              "value": this.model0.organization_logo._fileNames
            }, 
